...
import 'package:appointment_system/widgets/contact_box.dart';
import 'package:appointment_system/widgets/doctor_info_box.dart';
import 'package:appointment_system/widgets/mybutton.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Doctor's Profile", style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w600),),
      ),
      body: getBody(),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Column(
                ...
                children: [
                  const Text("Dr. Terry Aminoff", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700)),
                  const SizedBox(height: 5, ),
                  const Text("Dentist Specialist", style: TextStyle(color: Colors.grey, fontSize: 14),),
                ],
              ),
          ...
          const SizedBox(height: 5, ),
          const Text("4.0 Out of 5.0", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
          const SizedBox(height: 3, ),
          const Text("340 Patients review", style: const TextStyle(color: Colors.grey, fontSize: 12),),
          const SizedBox(height: 25, ),
          Row(
